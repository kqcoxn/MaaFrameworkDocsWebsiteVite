...
_⭐If you use the boilerplate, just modify it directly in [folder](https://github.com/MaaXYZ/MaaPracticeBoilerplate/tree/main/assets/resource)._
...
You can modify the names of files and folders starting with "my\_", but the others have fixed file names and should not be changed. Here's a breakdown:
...
_⭐If you use the boilerplate, just follow its documentation and run `configure.py` to automatically deploy the model file._
...
_⭐If you use the boilerplate, follow its documentation directly and run `install.py` to automatically package the relevant files._
...
Please refer to the [Integration Documentation](../binding/index.md).
